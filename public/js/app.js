...
__webpack_require__(/*! ./card-generator */ "./resources/js/card-generator.js");
...
window.addEventListener("load", function () {
  ...
  var skills = document.getElementsByClassName('skill-text');
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      elem.lastChild.lastChild.innerHTML = elem.lastChild.lastChild.innerHTML.replaceAll(/{(.*?)\|(.*?)}/gmi, "<span class='skill skill-$1'>$2</span>").replaceAll(/\[(.*?)\|(.*?)]/gmi, "<span class='trait trait-$1'>$2</span>").replaceAll(/#atk#/gmi, "<span class='atk'>&nbsp;&nbsp;</span>").replaceAll(/#def#/gmi, "<span class='def'>&nbsp;&nbsp;</span>").replaceAll(/#technologic#/gmi, "<span class='technologic'>&nbsp;&nbsp;</span>").replaceAll(/#biologic#/gmi, "<span class='biologic'>&nbsp;&nbsp;</span>").replaceAll(/#espectral#/gmi, "<span class='espectral'>&nbsp;&nbsp;</span>").replaceAll(/#dimensional#/gmi, "<span class='dimensional'>&nbsp;&nbsp;</span>");
  ...
  var traits = document.getElementsByClassName('skills-traits');

  var _iterator2 = _createForOfIteratorHelper(traits),
      _step2;

  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var _elem = _step2.value;
      _elem.innerHTML = _elem.innerHTML.replaceAll(/{(.*?)\|(.*?)}/gmi, "<span class='skill skill-$1'>$2</span>").replaceAll(/\[(.*?)\|(.*?)]/gmi, "<span class='trait trait-$1'>$2</span>");
  ...
  try {
    var _loop = function _loop() {
      ...
      var cardid = node.getAttribute('data-cardid'); // domtoimage.toBlob(node)
      //     .then(function (blob) {
      //         saveAs(blob, number + ".png");
      //     });

      dom_to_image__WEBPACK_IMPORTED_MODULE_0___default().toJpeg(node, {
        quality: 1
      }).then(function (blob) {
        file_saver__WEBPACK_IMPORTED_MODULE_1___default()(blob, cardid + ".jpg");
